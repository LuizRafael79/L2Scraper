...
class MainTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.start_btn = QPushButton("⚔️ Start Main Scraping")
        ...
        # Estatísticas
        stats_group = QGroupBox("📊 Main Statistics")
    ...
    def generate_items_lists(self):
        ...
        try:
            counts = self.config.generate_items_lists(self.site_type)
    ...
    def start_scraping(self):
        if not self.scraper_worker or not self.scraper_worker.isRunning():
            ...
            self.log("🚀 Starting Main site scraping...")
    ...
    def retry_failed(self):
        self.config.clear_failed_items("main")
        self.start_scraping()
        self.log("🔄 Retrying failed items for Main site...")
    ...
    def scraping_finished(self):
        ...
        self.log("✅ Main site scraping completed!")
        self.stats_updated.emit()
